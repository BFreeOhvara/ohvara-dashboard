...
// All say-this lines from the closer script in order, for the SAY THIS stepper.
          ...
          <div style={{
            ...
            <div className="scrollbar-thin" style={{ flex: 1, overflowY: 'auto' }}>
              ...
              <div style={{ padding: '14px 18px' }}>
                <p style={{ fontSize: 10, color: 'var(--accent)', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 600, margin: '0 0 10px' }}>
                  Say This
                </p>
                <div style={{
                  ...
                  <p style={{ fontSize: 10, color: 'var(--text-muted)', margin: '10px 0 0', fontFamily: 'var(--font-mono)' }}>
