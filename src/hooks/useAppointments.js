  ...
  return useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        ...
        .select(`
          *,
          lead:leads(id, business_name, contact_name, phone, email, niche, city, state, pain_points, notes, job_title, monthly_labor_cost, calls_missed_per_week, avg_ticket, recommended_automations, custom_monthly_price, recommended_stack, stack_generated_at, google_rating, google_review_count, has_website),
