...
export const DISCOVERY_SCRIPT = [
  {
    ...
    lines: [
      ...
      `   ↳ IF That's me [GOOD]: "Quick question — how's it going handling calls day-to-day? Anything been kind of a headache, or does it feel pretty dialed in?"`,
      `      BRANCH — How do they answer?`,
      `      ↳ IF Calls slip through when things get busy [GOOD]: → Go to Vitals Check`,
      `      ↳ IF Scheduling's a mess / hard to keep track of [GOOD]: → Go to Vitals Check`,
      `      ↳ IF Slow to get back to people [GOOD]: → Go to Vitals Check`,
      `      ↳ IF Whoever answers now isn't reliable [GOOD]: → Go to Vitals Check`,
      `      ↳ IF That's literally why we're hiring — can't keep up on the phones [GOOD]: → Go to Vitals Check`,
      ...
      `   ↳ IF Transferring [HESITANT]: "Hey — I saw y'all were hiring for a [job title]. I don't know if you can help me, but quick question — how's it going handling calls day-to-day? Anything been kind of a headache, or does it feel pretty dialed in?"`,
      `      BRANCH — How do they answer?`,
      `      ↳ IF Calls slip through when things get busy [GOOD]: → Go to Vitals Check`,
      `      ↳ IF Scheduling's a mess / hard to keep track of [GOOD]: → Go to Vitals Check`,
      `      ↳ IF Slow to get back to people [GOOD]: → Go to Vitals Check`,
      ...
      `      ↳ IF Engages [GOOD]: "Quick question — how's it going handling calls day-to-day? Anything been kind of a headache, or does it feel pretty dialed in?"`,
      `         BRANCH — How do they answer?`,
      `         ↳ IF Calls slip through when things get busy [GOOD]: → Go to Vitals Check`,
      `         ↳ IF Scheduling's a mess / hard to keep track of [GOOD]: → Go to Vitals Check`,
      `         ↳ IF Slow to get back to people [GOOD]: → Go to Vitals Check`,
      ...
      `         ▸ Set status Not Interested.`,
      `   ↳ IF Genuinely wrong number/business [BAD]: "My apologies for the mix-up — have a good one."`,
      `      ▸ Set status Not Interested.`,
    ],
...

  {
    ...
    lines: [
      ...
      `         ↳ IF Gives a time [HESITANT]: "Perfect — I'll follow up with you then."`,
      `            ▸ Set status Follow-Up (log the callback window they gave).`,
      ...
      `      BRANCH — Do they give a time, or say they're not interested?`,
      `      ↳ IF Gives a time [HESITANT]: "Got it — I'll follow up with you then."`,
