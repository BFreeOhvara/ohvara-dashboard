...
export const DISCOVERY_SCRIPT = [
  {
    ...
    lines: [
      ...
      `      ↳ IF No, we've got it covered, just growing [BAD]: "I hear you — most people think that until they actually track it for a week and realize something's slipping. Has anyone actually counted?"`,
      ...
      `               ↳ IF Still shuts it down [BAD]: "All good, man — appreciate your time. Take care."`,
      `                  ▸ Set status Not Interested.`,
      `      ↳ IF No, not interested [BAD]: "Got it — appreciate your time, have a good one."`,
      `         ▸ Set status Not Interested.`,
  ...
  {
    id: 'scheduling', kind: 'branch', short: 'Scheduling',
    title: 'Scheduling Check', trigger: `Scheduling chaos was the named pain — confirm it's really the headache, then quantify double-bookings/wasted time instead of missed calls`,
    goal: 'A one-beat yes/no confirm that scheduling is genuinely the headache, before asking the scheduling-specific quantifying question — a "no" reroutes rather than forcing a number. On a yes, state a pain-amplification line reflecting time and customer loss (not call loss), then check if it lands before handing off.',
    color: 'var(--warning)', dim: 'rgba(245,158,11,0.08)', border: 'rgba(245,158,11,0.25)',
    lines: [
      `"So is scheduling actually the main headache?"`,
      `BRANCH — Do they confirm?`,
      `↳ IF Yes [GOOD]: "Out of curiosity — how many appointments end up double-booked or mixed up in a given month? And how much time a week would you say somebody spends just untangling the calendar because of it?"`,
      `   "So that's real time every week somebody's burning fixing scheduling instead of actually running the business — and probably a customer or two along the way who just doesn't rebook after getting bounced around."`,
      `   "Is that something you're actually looking to fix, or is it just background noise at this point?"`,
      `   BRANCH — How do they respond?`,
      `   ↳ IF Engaged / "yeah that's annoying" [GOOD]: → Go to Handoff`,
      `   ↳ IF Minimizes / "it's not that bad" [HESITANT]: "Fair — but even one mixed-up appointment a week is a customer who shows up to nothing, or you showing up to nobody. That adds up fast. Worth 15 minutes to see how a system keeps that from happening at all?"`,
      `      BRANCH — Do they engage?`,
      `      ↳ IF Engages [GOOD]: → Go to Handoff`,
      `      ↳ IF Still no [BAD]: "Okay, well, that's a different story then — have a good day, good luck to you."`,
      `         ▸ Set status Not Interested.`,
      `   ↳ IF Pushback, "you're trying to sell me a service" [BAD]: "Yeah, no, nothing to buy here — I just happen to see y'all are dealing with it. Worth 15 minutes to see what fixing it actually looks like?"`,
      `      BRANCH — Do they re-engage?`,
      `      ↳ IF Re-engages [GOOD]: → Go to Handoff`,
      `      ↳ IF Still cold [BAD]: "Okay, well, that's a different story then — have a good day, good luck to you."`,
      `         ▸ Set status Not Interested.`,
      `↳ IF No [BAD]: "Gotcha — so is it more calls slipping through, or you're just growing and need more hands?"`,
      `   BRANCH — Which is it?`,
      `   ↳ IF Calls slipping [HESITANT]: → Go to Vitals Check`,
      `   ↳ IF Growing / need more hands [HESITANT]: → Go to Hiring Cost Check`,
      `   ↳ IF Neither, genuinely fine [BAD]: "Okay, well — thank you for your time. Good luck with everything."`,
      `      ▸ Set status Not Interested.`,
    ],
    tips: `Confirm before you quantify — a lead can land here loosely and say no, so don't force the "how many double-booked" question on an assumption. This is also the one angle that genuinely isn't a missed-call problem — don't force the "$[monthly] on the table" line here either, it doesn't fit. On a yes, quantify in double-bookings and wasted time, then check engagement the same way Pain Amplification does: engaged goes straight to Handoff, minimizers get one more concrete image (a customer bounced), pushback gets one disarm. Two real "no"s and you exit clean, same as everywhere else.`,
  },

  {
    id: 'hiringCost', kind: 'branch', short: 'Hiring Cost',
    title: 'Hiring Cost Check', trigger: `Cost-of-hiring was the named pain — no lead-asked number, reflect their own posted labor cost back instead`,
    goal: 'Skip asking for a number they\'ve already put in the job posting — reference their own budgeted labor cost conversationally, anchor against the cost of the hire they\'re trying to make, then check engagement before handing off.',
    color: 'var(--warning)', dim: 'rgba(245,158,11,0.08)', border: 'rgba(245,158,11,0.25)',
    lines: [
      `"Yeah, that makes sense — and look, [labor cost line] I mean, that's a real cost whether you end up filling the role or not. So is finding a way to cover this without adding headcount something you're actually open to, or is hiring still where your head's at?"`,
      `BRANCH — How do they respond?`,
      `↳ IF Engaged / open to an alternative to hiring [GOOD]: → Go to Handoff`,
      `↳ IF Minimizes / "we still need a person anyway" [HESITANT]: "Fair enough — but even if you do hire, this still catches everything that slips through nights, weekends, lunch, whenever they're not on the phone. So it's less either/or, more making sure nothing falls through the cracks either way. Worth 15 minutes to see what that'd actually look like?"`,
      `   BRANCH — Do they engage?`,
      `   ↳ IF Engages [GOOD]: → Go to Handoff`,
      `   ↳ IF Still no [BAD]: "Okay, well, that's a different story then — have a good day, good luck to you."`,
      `      ▸ Set status Not Interested.`,
      `↳ IF Pushback, "you're trying to sell me a service" [BAD]: "Yeah, no, nothing to buy here — I just happen to see you're hiring for this. Figured it's worth 15 minutes before you commit to a full-time hire for it — you open to that?"`,
      `   BRANCH — Do they re-engage?`,
      `   ↳ IF Re-engages [GOOD]: → Go to Handoff`,
      `   ↳ IF Still cold [BAD]: "Okay, well, that's a different story then — have a good day, good luck to you."`,
      `      ▸ Set status Not Interested.`,
    ],
    tips: `No Vitals numbers for this angle — [labor cost line] pulls straight from what they already posted for this role (leads.monthly_labor_cost), so don't ask them to state a number they've already put in writing. If that field's empty on this lead, the line falls back to a generic "hiring isn't cheap either" framing — same branch structure either way. Ties back to the standing rule: always anchor against the cost of a human hire, not competitors.`,
  },

  {
    id: 'vitals', kind: 'branch', short: 'Vitals',
    title: 'Vitals', trigger: `They're in — confirm calls are really the gap, then get the numbers that build the pain`,
    goal: 'Monthly call volume for rapport, then a one-beat yes/no confirm that calls are genuinely the gap before asking for a number — a "no" reroutes to whichever other angle actually fits instead of forcing a fabricated (or zero) figure into the pain math downstream. A "yes" continues into the direct daily-miss number, then ticket value.',
    color: 'var(--accent)', dim: 'rgba(108,99,255,0.08)', border: 'rgba(108,99,255,0.25)',
    lines: [
      `"Out of curiosity — how many calls do you think you get in a month?"`,
      `"So, are you actually missing calls?"`,
      `BRANCH — Do they confirm?`,
      `↳ IF Yes [GOOD]: "Ballpark, how many do you think you're missing a day?"`,
      `   "And what do you charge a client typically — like [$250] bucks?"`,
      `   → Go to Pain Amplification`,
      `↳ IF No [BAD]: "Gotcha — so is it more the scheduling side, or you're just growing and need more hands?"`,
      `   BRANCH — Which is it?`,
      `   ↳ IF Scheduling [HESITANT]: → Go to Scheduling Check`,
      `   ↳ IF Growing / need more hands [HESITANT]: → Go to Hiring Cost Check`,
      `   ↳ IF Neither, genuinely fine [BAD]: "Okay, well — thank you for your time. Good luck with everything."`,
      `      ▸ Set status Not Interested.`,
    ],
    ...
    tips: `Monthly volume is a warm-up, not a capture — it just gets them talking before the real numbers. The confirm gate right after it matters: don't skip straight to "how many are you missing a day" on an assumption — a lead who picked "calls piling up" loosely at the gate can still say no here, and that's fine, reroute them rather than forcing a number. Only on a real yes does the daily-miss question (type exactly what they say, the app converts it, no math on the call) and ticket value follow.`,
  },

  {
    ...
    lines: [
      ...
      `   ↳ IF Still no [BAD]: "Okay, well, that's a different story then — have a good day, good luck to you."`,
      `      ▸ Set status Not Interested.`,
      `↳ IF Pushback, "you're trying to sell me a service" [BAD]: "Yeah, no, there's nothing to buy, man — I just happen to see you guys. I mean, $[annual] every year — is that something you're doing anything about, or not important?"`,
      `   BRANCH — Do they re-engage?`,
      `   ↳ IF Re-engages [GOOD]: → Go to Handoff`,
...

  {
    ...
    lines: [
      `"Look, I don't want to waste your time — like I said, that's money slipping through the cracks. So here's what I'll do for you: we'll build you a system made exactly for this — it catches the calls you'd otherwise miss, answers questions 24/7, and books straight to your calendar. All you have to do is show up. Take 15 minutes — worst case, you see exactly what it looks like. Best case, we get those money cracks sealed and you're not wasting any more time. Sounds like a win-win to me — what do you think?"`,
      `BRANCH — How do they respond?`,
      `↳ IF Good / shows interest [GOOD]: "Good — looks like you guys are out in [city], [state]. So — do mornings or afternoons work better for you?"`,
      ...timeOfDayOfferFlow('   '),
      `   ↳ IF Still hesitant [HESITANT]: "No worries — like I was saying, it's just 15 minutes. They'll show you exactly how the system works and how it'd actually help what you're dealing with. Just hear them out — how's that sound?"`,
      `      BRANCH — Do they engage this time?`,
      ...
      `         ↳ IF Not a good fit [BAD]: "All good, man — appreciate your time. Take care."`,
      `            ▸ Set status Not Interested.`,
      `↳ IF Just send me some info [HESITANT]: "Yeah, 100% — but honestly, when's the last time an email did more for you than an actual conversation? Let's hop on a quick call instead — our team will walk you through exactly how this can actually help you. All you gotta do is listen. How's that sound?"`,
      `   BRANCH — Do they agree?`,
      `   ↳ IF Okay, fair [GOOD]: "So — do mornings or afternoons work better for you?"`,
      ...timeOfDayOfferFlow('      '),
      ...
      `         ▸ Set status Not Interested.`,
      `   ↳ IF Still wants info first [HESITANT]: "No worries — if you don't mind me asking, what's kind of holding you back?"`,
      `      BRANCH — Do they open up, or say they're not interested?`,
      `      ↳ IF Opens up [HESITANT]: "It's really just 15 minutes to see if it's even worth pursuing — no pressure, no commitment. If it's not a fit, we part ways, no hard feelings."`,
      `         BRANCH — Do they engage this time?`,
      `         ↳ IF Engages [GOOD]: "Okay, perfect — do mornings or afternoons work better for you?"`,
      ...
      `   ↳ IF Those don't work either [BAD]: "No worries — what's a good time for ya?"`,
      `      BRANCH — Do they give a time, or say they're not interested?`,
      `      ↳ IF Gives a time [GOOD]: → Go to Close`,
      `      ↳ IF Not interested [BAD]: "All good, man — appreciate your time. Take care."`,
      `         ▸ Set status Not Interested.`,
      ...
      `   BRANCH — How do they respond?`,
      `   ↳ IF Agrees [GOOD]: "So — do mornings or afternoons work better for you?"`,
      ...timeOfDayOfferFlow('      '),
      `      ↳ IF Still hesitant [HESITANT]: "No worries — if you don't mind me asking, what's kind of holding you back?"`,
      `         BRANCH — Do they open up, or say they're not interested?`,
      `         ↳ IF Opens up [HESITANT]: "It's really just 15 minutes to see if it's even worth pursuing — no pressure, no commitment. If it's not a fit, we part ways, no hard feelings."`,
      ...
      `      ↳ IF Not interested [BAD]: "All good, man — appreciate your time. Take care."`,
      `         ▸ Set status Not Interested.`,
      `↳ IF How much does this cost? [BAD]: "Honestly depends on your call volume and setup — which is exactly what our team figures out on the call. Didn't want to guess at a number before they've seen your actual setup. Does that sound fair?"`,
      `   BRANCH — Do they push for a ballpark?`,
      `   ↳ IF Okay [GOOD]: "So — do mornings or afternoons work better for you?"`,
      ...timeOfDayOfferFlow('      '),
      `      ↳ IF Still hesitant [HESITANT]: "No worries — if you don't mind me asking, what's kind of holding you back?"`,
      `         BRANCH — Do they open up, or say they're not interested?`,
      `         ↳ IF Opens up [HESITANT]: "It's really just 15 minutes to see if it's even worth pursuing — no pressure, no commitment. If it's not a fit, we part ways, no hard feelings."`,
      ...
      `      ↳ IF Not interested [BAD]: "All good, man — appreciate your time. Take care."`,
      `         ▸ Set status Not Interested.`,
      `   ↳ IF Just need a ballpark [HESITANT]: "The range is wide depending on what you need — just set aside 15 minutes, hear the team out, and they'll give you an accurate number based on what you need. You can decide from there."`,
...
function fillTokens(text, lead, rep) {
  ...
  // Prompt 317 — Hiring Cost Check reflects the lead's own posted labor cost
  // back at them instead of asking them to state a number they've already
  // put in the job posting (leads.monthly_labor_cost, scraped from Indeed).
  // Composite token (same pattern as [city], [state]) so a missing value
  // doesn't leave a dangling clause — falls back to a generic framing when
  // the field wasn't populated for this lead (~35% of leads as of Prompt 317).
  const laborCost = parseFloat(lead.monthly_labor_cost)
  const laborCostLine = laborCost > 0
    ? `you're already looking at putting somebody on payroll for around $${Math.round(laborCost).toLocaleString()}/month for this —`
    : `hiring someone full-time for this isn't cheap either —`
  return text
    ...
    .replace(/\[labor cost line\]/gi, laborCostLine)
}
...
function routeTarget(t) {
  ...
  if (/scheduling/i.test(t))  return 'scheduling'
  if (/hiring cost/i.test(t)) return 'hiringCost'
  if (/urgency/i.test(t))     return 'urgency'
