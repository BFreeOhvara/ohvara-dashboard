import { CheckCircle, Clock, Loader2, AlertTriangle, Eye } from 'lucide-react'
    ...
    <div style={{ maxWidth: 800 }}>
      ...
      {automations.length === 0 ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          {automations.map((a, i) => {
            const stats = syntheticStatsFor(a, i)
            return (
              <div key={i} className="glass" style={{ padding: '14px 16px', borderRadius: 10 }}>
